from temp.queues import QUEUE, clear_queue, get_queue, pop_an_item
from temp.client_base import bot, call_py
from Konfig import IMG_4
...
keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(text="⛓️ Open Menu", callback_data="cbmenu"),
